...
{
      -1,    -7,     0,    -7,     0,     1,    11,    15,    -7,    -7,
       7,    -7,     0,     0,    -7,     0,     0,    -7,    15,    15,
      -7,    -7
};
...
{
       0,    11,     0,     3,     0,     0,     0,     6,     9,    12,
       0,     1,     0,     0,     2,     0,     0,    10,     4,     5,
       7,     8
};
...
{
       9,    11,     1,     1,     2,     2,    18,    19,     3,     4,
       4,    12,    13,    20,    21,    12,    13,    10,    17,     0,
      14,    15,    16
};

static const yytype_int8 yycheck[] =
{
       2,     0,     3,     3,     5,     5,    12,    13,     9,    10,
      10,     4,     5,    15,    16,     4,     5,     4,    11,    -1,
       9,     6,     7
};
...
{
       0,     3,     5,     9,    10,    13,    14,    15,    16,    16,
      14,     0,     4,     5,     9,     6,     7,    11,    15,    15,
      16,    16
};
...
#line 57 "q1.y"
                      { (yyval.ival) = newNode("+", (yyvsp[-2].ival), (yyvsp[0].ival)); }
#line 1119 "q1.tab.c"
    break;
...
#line 70 "q1.y"
                      { (yyval.ival) = newNode((yyvsp[0].sval), -1, -1); free((yyvsp[0].sval)); }
#line 1161 "q1.tab.c"
    break;

  case 12: /* factor: '-' factor  */
#line 71 "q1.y"
                              { (yyval.ival) = newNode("-u", (yyvsp[0].ival), -1); }
#line 1167 "q1.tab.c"
    break;
