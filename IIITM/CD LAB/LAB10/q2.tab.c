...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_array_rvalue = 24,              /* array_rvalue  */
  YYSYMBOL_array_lhs = 25                  /* array_lhs  */
};
...
{
       0,    58,    58,    63,    93,    95,   100,   106,   114,   121,
     128,   133,   140,   147,   152,   159,   160,   166,   180,   208,
     213
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'*'", "'/'", "'+'", "'-'", "'='", "';'", "'('", "')'", "'['", "']'",
  "$accept", "program", "decls", "stmt_list", "stmt", "expr", "term",
  "factor", "array_rvalue", "array_lhs", YY_NULLPTR
};
...
{
      -9,    11,    -9,    -9,    -2,    -8,    -9,     0,    -9,     8,
       1,    -9,    -9,    18,    19,    15,     5,     0,     0,    -9,
       0,     0,     0,    16,    27,    -9,     1,     1,    -9,    -9,
      12,    -5,    17,    -9,    30,    20,    21,    32,    28,    22,
      -9
};
...
{
       3,     0,     4,     1,     2,     0,    14,     0,     5,     0,
      10,    13,    15,     0,     0,     0,     0,     0,     0,     7,
       0,     0,     0,     0,     0,    16,     8,     9,    11,    12,
       0,    17,     0,     6,     0,    17,     0,     0,    18,     0,
      18
};
...
{
      16,     5,     6,    15,     6,   -19,    14,    20,    21,    34,
       7,     3,     7,    17,    18,    30,    17,    18,    25,    19,
      17,    18,    23,    33,    26,    27,    28,    29,    22,    24,
      32,    31,    35,    36,    37,    39,    38,    40,   -20
};

static const yytype_int8 yycheck[] =
{
       7,     3,     4,     3,     4,    10,    14,     6,     7,    14,
      12,     0,    12,     8,     9,    22,     8,     9,    13,    11,
       8,     9,     3,    11,    17,    18,    20,    21,    10,    14,
       3,    15,    15,     3,    14,     3,    15,    15,    10
};
...
{
       0,    17,    18,     0,    19,     3,     4,    12,    20,    21,
      22,    23,    24,    25,    14,     3,    21,     8,     9,    11,
       6,     7,    10,     3,    14,    13,    22,    22,    23,    23,
      21,    15,     3,    11,    14,    15,     3,    14,    15,     3,
      15
};
...
#line 1267 "q2.tab.c"
  ...
  case 17: /* array_rvalue: ID '[' ID ']'  */
#line 166 "q2.y"
                    {
          int offset = dtype_size;
          char *t1 = newtemp();
          printf("After reduction number %d\n", reduction++);
          printf("%s = %s * %d\n", t1, (yyvsp[-1].sval), offset);

          char *t2 = newtemp();
          printf("After reduction number %d\n", reduction++);
          printf("%s = %s[%s]\n", t2, (yyvsp[-3].sval), t1);

          free((yyvsp[-3].sval)); free((yyvsp[-1].sval)); free(t1);
          (yyval.sval) = t2;
      }
#line 1285 "q2.tab.c"
    break;

  case 18: /* array_rvalue: ID '[' ID ']' '[' ID ']'  */
#line 180 "q2.y"
                               {
          ...
          char *t1 = newtemp();
          printf("After reduction number %d\n", reduction++);
          printf("%s = %s * %d\n", t1, (yyvsp[-4].sval), size1);

          char *t2 = newtemp();
          printf("After reduction number %d\n", reduction++);
          printf("%s = %s * %d\n", t2, (yyvsp[-1].sval), dtype_size);
...
#line 1314 "q2.tab.c"
  ...
  case 19: /* array_lhs: ID '[' ID ']'  */
#line 208 "q2.y"
                    {
          char *s = build_lhs_text((yyvsp[-3].sval), (yyvsp[-1].sval), NULL);
...
#line 1324 "q2.tab.c"
  ...
  case 20: /* array_lhs: ID '[' ID ']' '[' ID ']'  */
#line 213 "q2.y"
                               {
          char *s = build_lhs_text((yyvsp[-6].sval), (yyvsp[-4].sval), (yyvsp[-1].sval));
          free((yyvsp[-6].sval)); free((yyvsp[-4].sval)); free((yyvsp[-1].sval));
          (yyval.sval) = s;
      }
#line 1334 "q2.tab.c"
